...
public class NVPAPICaller
{
  ...
  public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
  {
    ...
    using (EcommerceWebApp.Logic.ShoppingCartActions myCartOrders = new EcommerceWebApp.Logic.ShoppingCartActions())
    {
  ...
  public string HttpCall(string NvpRequest)
  {
    ...
    {
      // Log the exception.
      EcommerceWebApp.Logic.ExceptionUtility.LogException(e, "HttpCall in PayPalFunction.cs");
    }
